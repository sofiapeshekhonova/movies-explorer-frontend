    ...
    <section className="portfolio">
      ...
      <ul className="portfolio__list">
        <li className="portfolio__works">
          <a
            className="portfolio__link text-hover"
            href="https://github.com/sofiapeshekhonova/how-to-learn"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="portfolio__works">
          <a
            className="portfolio__link text-hover"
            href="https://github.com/sofiapeshekhonova/russian-travel"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="portfolio__works">
          <a
            className="portfolio__link text-hover"
            href="https://github.com/sofiapeshekhonova/react-mesto-api-full-gha"
            target="_blank"
            rel="noreferrer"
          >
